...
# Parsing + Configuration Script – AXE MP D320 - Rev. A

This **Parsing + Configuration** script is designed for the **AXE MP D320** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AXE MP D320 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AXE MP D320** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
